...
<!-- revision_01231600 -->ヘッダーの「アカウント」ボタンをクリックし、メニューから「パスワード変更」を選択します。<!-- revision_01231600 -->
...
<!-- revision_01231600 -->ホーム画面からフォルダ／ファイルを選択し、右クリックします。コンテクストメニューから「ダウンロード」を選択し、「ファイル単位でダウンロード」もしくは「ZIPダウンロード」を選択します。<!-- revision_01231600 -->
...
<!-- revision_01231600 -->ホーム画面から対象のファイル / フォルダを選択し、「名前変更」アイコンをクリックします。<!-- revision_01231600 -->
...
1. <!-- revision_01231600 -->ホーム画面から対象のファイル / フォルダを選択し、「削除」アイコンをクリックします。<!-- revision_01231600 -->
...
2. <!-- revision_01231600 -->完全に削除したいフォルダ／ファイルを選択し、「完全削除」ボタンをクリックします。<!-- revision_01231600 -->

<!-- revision_01231600 -->ごみ箱内にあるフォルダ／ファイルを全て削除したい場合は、「空にする」ボタンをクリックします。<!-- revision_01231600 -->
...
<!-- revision_01231600 -->但し、戻したいフォルダ／ファイルを「完全削除」／「空にする」ボタンをクリックして削除をした場合、元に戻すことはできません。<!-- revision_01231600 -->


1. ホーム画面の左メニューから「ゴミ箱」を選択します。

2. <!-- revision_01231600 -->元に戻したいフォルダ／ファイルを選択し「元に戻す」ボタンをクリックします。<!-- revision_01231600 -->

3. <!-- revision_01231600 -->移動先の選択画面が表示されますので、フォルダ／ファイルの移動時と同様の操作を行います。<!-- revision_01231600 -->
...
1. <!-- revision_01231600 -->ヘッダーの検索エリアにフォルダ／ファイル名を入力し、キーボードのEnterを押します。<!-- revision_01231600 -->
...
<!-- revision_01231600 -->「虫めがね」ボタンをクリックして詳細検索画面を表示し、検索したいファイル / フォルダの条件を絞り込んで検索できます。<!-- revision_01231600 -->
...
<!-- revision_01241700 -->ホーム画面からフォルダ／ファイルを選択し、右クリックします。コンテクストメニューから「お気に入り」を選択します。<!-- revision_01241700 -->

<!-- revision_01241700 -->コンテクストメニューから「お気に入り」を再度選択すると、お気に入りを削除できます。<!-- revision_01241700 -->
...
1. <!-- revision_01241700-->ホーム画面からフォルダ／ファイルを選択し、右クリックします。コンテクストメニューから「期限設定」を選択します。<!-- revision_01241700 -->
<!-- revision_01241700-->操作の詳細はこちらをご参照ください。<!-- revision_01241700 -->
...
1. <!-- revision_01241700 -->ホーム画面からフォルダ／ファイルを選択し、右クリックします。コンテクストメニューから「ロック設定」を選択します。<!-- revision_01241700 -->
<!-- revision_01241700 -->操作の詳細はこちらをご参照ください。<!-- revision_01241700 -->
...
1. <!-- revision_01241700-->ホーム画面からフォルダ／ファイルを選択し、右クリックします。コンテクストメニューから「バージョン設定」を選択します。<!-- revision_01241700 -->
<!-- revision_01241700-->操作の詳細はこちらをご参照ください。<!-- revision_01241700 -->
...
1. ホーム画面から対象のファイルの状態列に表示されている「バージョン管理」アイコンをクリック、またはプロパティ画面からバージョン設定の「設定」ボタンをクリックします。
...
4. <!-- revision_01241700-->共有フォルダの容量を制限する場合は、「容量管理」タブをクリックし容量を設定します。<!-- revision_01241700 -->
...
1. <!-- revision_01241700-->ホーム画面からフォルダ／ファイルを選択し、右クリックします。コンテクストメニューから「フォルダを共有する」を選択します。<!-- revision_01241700 -->
...
<!-- revision_01241700-->左メニューから「共有されているフォルダ」アイコンをクリックします。共有されているフォルダの一覧からフォルダを選択し、右クリックします。コンテクストメニューから「フォルダを共有する」を選択します。<!-- revision_01241700 -->
...
1. <!-- revision_01241700-->ホーム画面からフォルダ／ファイルを選択し、右クリックします。コンテクストメニューから「ファイル／フォルダを送付する」を選択します。<!-- revision_01241700 -->
...
<!-- revision_01241700-->左メニューから「設定」アイコンをクリックし、「アップロードリンク一覧」を選択します。<!-- revision_01241700 -->
...
|  送付キーパスワード | 送付キーにパスワードを設定します。<br/>パスワードは任意の文字列、または自動生成できます。<br/>「自動生成する」にチェックをした場合、送付キーの発行者にパスワードが自動通知されます。<br/>※ パスワード通知メールは、日本語文と英語文が併記されます。<br/>※ パスワード通知メールには所有者の情報は表示されません。<br/>※ 同時に複数の送付キーを発行した場合、送付キーパスワードは共通のパスワードとなります。 |
...
1. <!-- revision_01281100 -->ホーム画面からフォルダ／ファイルを選択し、右クリックします。コンテクストメニューから「ダウンロードリンクを送付する」を選択します。<!-- revision_01281100 -->
...
1. 「Webメール送信」を選択した場合は、以下のメール作成画面が表示されます。
...
プライベートグループは、一般ユーザが作成する個人的なグループとなり、他のユーザへは公開されません。

パブリックグループは、コーポレート管理者、またはサブ管理者が管理画面から登録可能なグループとなり、全ユーザへ公開されます。

作成されたグループは、共有フォルダの共有メンバー、又はダウンロードキーやアップロードキーの送付対象として指定できます。
