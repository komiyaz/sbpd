...
### 【新】 PKIクライアント証明書によるログイン
### 【旧】2-3. PKIクライアント証明書を使用してログインする
#### <概要>
...
### 【新】 ユーザ共有設定情報のインポートによる共有メンバの削除方法
#### 【旧】<操作手順> 共有設定のインポートによる共有メンバの削除
...
## 【新】 ユーザ情報等のエクスポート
### 【旧】3-8. ユーザ一覧, ユーザ利用容量 / 最終ログイン日時, 共有設定一覧をエクスポートする
...
### 【新】 コーポレート全体への設定（適用・解除）
### 【旧】6-2. コーポレート全体へIPアドレス接続制限を適用、または解除する
#### <操作手順>
...
### 【新】 個別ユーザへの設定（適用・解除）
### 【旧】6-3. ユーザへ個別にIPアドレス接続制限を適用、または解除する
#### <操作手順>
...
## 【新】 フォルダ／ファイルの管理閲覧・ごみ箱操作
### 【新】 管理閲覧できるフォルダ／ファイルについて
### 【旧】3-11-1. ファイル・フォルダの参照
【参照できるフォルダ、ファイル】
