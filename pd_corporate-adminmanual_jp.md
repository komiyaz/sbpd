...
3. <!-- revision_01311100 -->パスワード入力欄へ新しい情報を入力して、「確認画面へ」ボタンをクリックします。<!-- revision_01311100-->
...
2. <!-- revision_01311100 -->タブの「セキュリティ」を選択し、「IPアドレス接続制限」項目で「制限する」を選択します。（設定を解除する場合は、「制限しない」を選択します）<!-- revision_01311100-->
...
2. <!-- revision_01311100 -->タブの「認証」を選択し、「PKI証明書」項目で「利用する」を選択します。<!-- revision_01311100 -->

3. <!-- revision_01311100 -->「パブリックOU」入力欄へOU番号（Organization Unit Code）を入力します。<!-- revision_01311100 -->

4. <!-- revision_01311100 -->「この内容で登録」ボタンをクリックします。<!-- revision_01311100 -->
...
1. <!-- revision_01311100 -->グループ検索画面から対象グループを選択し、右クリックします。コンテクストメニューから「編集」を選択します。<!-- revision_01311100-->
