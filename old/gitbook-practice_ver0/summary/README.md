...
### パスワード変更
#### <操作手順>
1. <!-- revision_01311100 -->メイン画面の左メニューから「ユーザ管理」を選択し、対象ユーザを検索します。<!-- revision_01311100 -->

2. <!-- revision_01311100 -->ユーザ管理画面から対象ユーザを選択し、右クリックします。コンテクストメニューから「編集」を選択します。<!-- revision_01311100-->

3. 対象ユーザのユーザ情報編集画面が表示されます。

4. <!-- revision_01311100 -->パスワード入力欄へ新しい情報を入力して、「確認画面へ」ボタンをクリックします。<!-- revision_01311100-->
...
### 基本情報の登録
#### <操作手順>
1. <!-- revision_01311100 -->メイン画面の左メニューから「ユーザ管理」を選択します。<!-- revision_01311100-->

2. <!-- revision_01311100 -->メイン操作メニューから「新規登録」ボタンをクリックします。<!-- revision_01311100-->

3. <!-- revision_01311100 -->必須・任意項目を入力して、「確認画面へ」ボタンをクリックします。※「＋詳細情報を設定する（設定は後日でも可能です）」をクリックして、ユーザ基本情報（詳細）の任意項目も入力できます。<!-- revision_01311100-->

4. <!-- revision_01311100 -->確認画面にて、「確定」ボタンをクリックします。<!-- revision_01311100-->

5. <!-- revision_01311100 -->登録完了画面にて、「ユーザ一覧へ戻る」または「続けて登録する」ボタンをクリックします。<!-- revision_01311100 -->
...
3. <!-- revision_01311100 -->「＋詳細情報を設定する（設定は後日でも可能です）」をクリックして、ユーザポリシー（アクセス制限）、ユーザポリシー（機能制限）の任意項目を入力します。<!-- revision_01311100-->
...
3. <!-- revision_01311100 -->ユーザ基本情報、ユーザ基本情報（詳細）、ユーザポリシー（アクセス制限）、ユーザポリシー（機能制限）を編集して、「確認画面へ」ボタンをクリックします。<!-- revision_01311100 -->
...
2. <!-- revision_01311100 -->ユーザ管理画面から対象ユーザを選択し、右クリックします。コンテクストメニューから「一括編集」を選択します。<!-- revision_01311100-->

3. <!-- revision_01311100 -->ユーザ基本情報、ユーザポリシー（アクセス制限）、ユーザポリシー（機能制限）を編集して、「確認画面へ」ボタンをクリックします。<!-- revision_01311100-->
...
2. <!-- revision_01311100 -->ユーザ管理画面から対象ユーザを選択し、右クリックします。コンテクストメニューから「削除」を選択します。<!-- revision_01311100 -->
...
3. <!-- revision_01311100 -->「＋詳細情報を設定する（設定は後日でも可能です）」をクリックしてます。<!-- revision_01311100 -->

4. <!-- revision_01311100 -->ユーザ基本情報（詳細）の「利用状況」項目を “ロック中（利用停止中）”に設定し、「確認画面へ」ボタンをクリックします。<!-- revision_01311100-->
...
#### <!-- revision_01311100 -->ロック・緊急ロックの解除方法<!-- revision_01311100-->
...
4. <!-- revision_01311100 -->ユーザ基本情報（詳細）の「利用状況」項目を “利用中”に設定し、「確認画面へ」ボタンをクリックします。<!-- revision_01311100 -->

5. <!-- revision_01311100 -->確認画面にて、「確定」ボタンをクリックします。<!-- revision_01311100 -->

## ユーザの検索方法
### 簡易検索
#### <操作手順> 簡易検索

1. <!-- revision_01311100 -->検索窓にユーザIDを入力し、キーボードのEnterを押します。<!-- revision_01311100-->
...
### 詳細検索
#### <操作手順> 詳細検索
1. <!-- revision_01311100 -->「詳細検索」アイコンをクリックして詳細検索画面を表示し、検索したいフォルダ／ファイルの条件を絞り込んで検索できます。<!-- revision_01311100-->

![代替テキスト](http://placehold.jp/30/e0e0e0/6e6e6e/500x100.png?text=%E7%94%BB%E5%83%8F%E5%A4%89%E6%9B%B4)


2. <!-- revision_01311100 -->検索条件を入力して、「検索する」ボタンをクリックします。<!-- revision_01311100 -->
...
1. <!-- revision_01311100 -->メイン画面の左メニューから「ユーザ管理」を選択し、メイン操作メニューから「インポート」ボタンをクリックします。<!-- revision_01311100 -->
...
3. <!-- revision_01311100 -->「ファイルを選択」ボタンをクリックして、インポートするファイルを選択します。<!-- revision_01311100 -->
...
1. <!-- revision_01311100 -->メイン画面の左メニューから「ユーザ管理」を選択し、メイン操作メニューから「エクスポート」ボタンをクリックします。<!-- revision_01311100-->
...
1. <!-- revision_01311100 -->メイン画面の左メニューから「コーポレートポリシー」を選択します。<!-- revision_01311100-->

2. コーポレートポリシー編集画面が表示されます。

3. <!-- revision_01311100 -->各タブの情報を編集して、「この内容で登録」ボタンをクリックします。<!-- revision_01311100-->
...
3. <!-- revision_01311100 -->タブの「セキュリティ」を選択し、「IPアドレス接続制限」項目で「制限する」を選択します。（設定を解除する場合は、「制限しない」を選択します）<!-- revision_01311100-->
...
1. <!-- revision_01311100 -->メイン画面の左メニューから「ユーザ管理」を選択して、対象ユーザを検索します。<!-- revision_01311100-->

2. <!-- revision_01311100-->ユーザ管理画面から対象ユーザを選択し、右クリックします。コンテクストメニューから「編集」を選択します。<!-- revision_01311100-->

3. <!-- revision_01311100 -->「＋詳細情報を設定する（設定は後日でも可能です）」をクリックします。<!-- revision_01311100 -->

4. <!-- revision_01311100 -->ユーザポリシー（アクセス制限）が表示され、「IPアドレス接続制限」の「ユーザポリシーを適用する」を選択します。<!-- revision_01311100 -->

5. <!-- revision_01311100 -->「接続許可IPアドレス一覧」項目に、許可するIPアドレスを入力して「追加」ボタンをクリックします。<!-- revision_01311100 -->

6. <!-- revision_01311100 -->IPアドレス一覧に情報が追加されたことを確認し、「確認画面へ」ボタンをクリックします。<!-- revision_01311100 -->

7. <!-- revision_01311100 -->確認画面にて、「確定」ボタンをクリックします。<!-- revision_01311100 -->
...
3. <!-- revision_01311100 -->タブの「認証」を選択し、「PKI証明書」項目で「利用する」を選択します。<!-- revision_01311100 -->

4. <!-- revision_01311100 -->「パブリックOU」入力欄へOU番号（Organization Unit Code）を入力します。<!-- revision_01311100 -->

5. <!-- revision_01311100 -->「この内容で登録」ボタンをクリックします。<!-- revision_01311100 -->

※ OU番号は、PKIサービス申込時の開通通知書をご覧ください。

※ 登録完了後は、PKIクライアント認証専用のログインURLをご利用いただきます。

※ <!-- revision_01311100 -->ログイン方法は、「ユーザマニュアル」の「PKIクライアント証明書によるログイン」をご覧ください。<!-- revision_01311100 -->
...
1. <!-- revision_01311100 -->メイン画面の左メニューから「パブリックグループ」を選択します。<!-- revision_01311100 -->

2. <!-- revision_01311100 -->グループ検索画面のメイン操作メニューから「新規登録」ボタンをクリックします。<!-- revision_01311100 -->

![代替テキスト](http://placehold.jp/30/e0e0e0/6e6e6e/500x100.png?text=%E7%94%BB%E5%83%8F%E5%A4%89%E6%9B%B4)


3. <!-- revision_01311100 -->グループ編集画面が表示され、項目を入力して、「登録」ボタンをクリックします。<!-- revision_01311100-->
...
2. <!-- revision_01311100 -->検索エリアにグループ名を入力し、キーボードのEnterを押します。<!-- revision_01311100-->
...
3. <!-- revision_01311100 -->グループ検索画面から対象グループを選択し、右クリックします。コンテクストメニューから「編集」を選択します。<!-- revision_01311100-->
...
2. <!-- revision_01311100 -->グループ検索画面のメイン操作メニューから「インポート」ボタンをクリックします。<!-- revision_01311100 -->
...
2. <!-- revision_01311100 -->グループ検索画面のメイン操作メニューから「エクスポート」ボタンをクリックします。<!-- revision_01311100 -->
...
<!-- revision_01311100 -->指定したユーザの「フォルダ、ファイルの参照」、「所有者の変更」、「ごみ箱を空にする」の操作を実行できます。<!-- revision_01311100 -->
...
* ごみ箱にあるフォルダとファイル<!-- revision_01311100 -->
...
2. <!-- revision_01311100 -->ユーザ管理画面から対象ユーザを選択し、右クリックします。コンテクストメニューから「検閲・所有者変更」を選択します。<!-- revision_01311100-->
...
### ユーザのごみ箱を空にする
<!-- revision_01311100 -->指定ユーザのごみ箱を空にすることができます。<!-- revision_01311100-->
...
3. <!-- revision_01311100 -->「ごみ箱」タブをクリックし、指定ユーザのごみ箱を表示します。<!-- revision_01311100 -->

4. <!-- revision_01311100 -->「ごみ箱を空にする」ボタンをクリックします。<!-- revision_01311100 -->
...
6. <!-- revision_01311100 -->対象ユーザ、保存先フォルダを確認し、「確認画面へ」ボタンをクリックします。<!-- revision_01311100 -->
...
<!-- revision_01311100 -->保存先のフォルダを変更する場合は、＜保存先フォルダも合わせて変更する場合＞を参照ください。<!-- revision_01311100 -->
...
5. <!-- revision_01311100 -->所有者変更(移動先選択)画面で、「保存先フォルダを変更する」にチェックをします。<!-- revision_01311100 -->

![代替テキスト](http://placehold.jp/30/e0e0e0/6e6e6e/500x100.png?text=%E7%94%BB%E5%83%8F%E5%A4%89%E6%9B%B4)


6. <!-- revision_01311100 -->「保存先フォルダ選択」ボタンをクリックします。<!-- revision_01311100 -->
...
<!-- revision_01311100 -->保存先フォルダを変更後、「保存先フォルダを変更する」のチェックを外しても、デフォルトのフォルダには切り替わりませんので、ご注意ください。<!-- revision_01311100-->


8. <!-- revision_01311100 -->対象ユーザ、保存先フォルダを確認し、「確認画面へ」ボタンをクリックします。<!-- revision_01311100-->
...
|  個人のオンラインドライブは利用できません。他のユーザから共有されたフォルダを権限の範囲で利用できます。 ＜利用例＞コーポレート管理者、または特定ユーザが保管データを一括管理したい場合は、ユーザアカウントの割当容量を"0"に指定します。ユーザへは、必要に応じてフォルダを共有することで、個人領域の使用を許可せず、管理者から共有したフォルダのみを使用するよう利用可能な範囲を制限できます。 |
|  ●容量を割当てない場合： |
...
![代替テキスト](https://primedrive.jp/yassweb/admin/images/capacity_note_ja.png)
...
2. <!-- revision_01311100 -->「お知らせ内容」に情報を入力し、「確認」ボタンをクリックします。<!-- revision_01311100-->

3. <!-- revision_01311100 -->確認画面にて、「登録」ボタンをクリックします。<!-- revision_01311100 -->
...
2. <!-- revision_01311100 -->「お知らせ内容」に情報を変更し、「確認」ボタンをクリックします。<!-- revision_01311100-->
...
2. <!-- revision_01311100 -->「お知らせ内容」に情報を削除し、「確認」ボタンをクリックします。<!-- revision_01311100-->
...
#### <操作手順>
<!—新規コンテンツ追加 --><br>
<!—1. メイン画面の左メニューから「通知メール雛形登録」を選択します。 --><br>
<!—2. 「通知メール」のプルダウンから編集したい雛形を選択します。 --><br>
<!—3. 「ヘッダー」「フッター」欄に選択した雛形が表示されます。内容を編集してください。 --><br>
<!—4. 「登録」ボタンをクリックします。 --><br>
<!—5. 確認画面にて、「確定」ボタンをクリックします。 --><br>
<!—新規コンテンツ追加 --><br>
## 注意事項
### 入力文字について
