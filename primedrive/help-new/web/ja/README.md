...
ユーザが個別にホーム配下のファイル／フォルダに対してファイルの有効期限を設定できます。
...
| ダウンロードリンク期限切れ<br>ファイルの自動削除 | 次の条件時にダウンロードリンクを発行したファイルが、自動的にサーバから完全削除されます。<br>(完全削除されたファイルを復元することはできませんのでご注意ください。)<br>・　ダウンロード残回数が0回になった場合<br>・　ダウンロードリンクの有効期限が切れた場合<br>ファイルのダウンロードリンクの発行時のみ選択ができます。(フォルダのダウンロードリンクの発行の場合は選択できません。)                                                                                                                                                                                  |
...
※　「閉じる」ボタンをクリックすると、メーラ選択画面を終了します。ダウンロードリンクは有効状態のままとなります。」
